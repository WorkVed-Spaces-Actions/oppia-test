...
Oppia is an online learning tool that enables anyone to easily create and share interactive (called 'explorations'). These activities simulate a one-on-one conversation with a tutor, enabling students to learn by doing while getting feedback.
