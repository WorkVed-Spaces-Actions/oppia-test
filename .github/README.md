...
Oppia is an online learning tool that enables anyone o easily create and share interactive activities (called 'explorations'). These activities simulate a one-on-one converation with a tutor, enabling students to learn by doing while getting feedback.
